...
const INTERESTS = [
  { value: "의료", label: "🏥 의료·건강", id: "int-medical" },
  { value: "주거", label: "🏠 주거·임대", id: "int-housing" },
  { value: "교육", label: "🎓 교육·장학", id: "int-education" },
  { value: "취업", label: "💼 취업·창업", id: "int-employment" },
  { value: "문화", label: "🎭 문화·여가", id: "int-culture" },
  { value: "육아", label: "👶 임신·육아", id: "int-childcare" },
  { value: "생활", label: "🛒 생활·복지", id: "int-living" },
  { value: "법률", label: "⚖️ 법률·권익", id: "int-legal" },
];

/**
 * 입력 폼 생성.
 * @param {Function} onSubmit - 폼 제출 콜백 (formData)
 */
